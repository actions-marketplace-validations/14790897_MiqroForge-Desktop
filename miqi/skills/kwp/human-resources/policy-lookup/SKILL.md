---
name: kwp-human-resources-policy-lookup
...
1. Search No knowledge base connected — use `web_search` and `read_file` to find documentation for the relevant policy document
