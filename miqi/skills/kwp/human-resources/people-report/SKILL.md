---
name: kwp-human-resources-people-report
...
2. Identify the right data (upload, paste, or pull from No HRIS connected — describe people data manually or use `exec`/`create_xlsx` for analysis)
...
If **No HRIS connected — describe people data manually or use `exec`/`create_xlsx` for analysis** is connected:
