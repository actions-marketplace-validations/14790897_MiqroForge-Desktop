---
name: kwp-marketing-brand-review
...
1. **Content to review** — accept content in any of these forms:
   ...
   - A file path or No knowledge base connected — use `web_search` and `read_file` to find documentation reference (e.g. Notion page, shared doc)
