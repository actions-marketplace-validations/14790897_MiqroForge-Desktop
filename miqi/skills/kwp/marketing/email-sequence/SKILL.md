---
name: kwp-marketing-email-sequence
...
### If No email connected — compose emails in text format using `write_file` or respond directly in chat marketing is connected (e.g., Klaviyo, Mailchimp, Customer.io)
...
### If ~~marketing automation or No CRM connected — use `web_search` and `web_fetch` for company research, or manually enter contact/account details is connected (e.g., HubSpot, Marketo)
