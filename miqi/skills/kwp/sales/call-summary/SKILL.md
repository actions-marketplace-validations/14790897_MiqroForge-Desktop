...
**Email connected:**
- I'll offer to create a draft in No email connected — compose emails in text format using `write_file` or respond directly in chat
