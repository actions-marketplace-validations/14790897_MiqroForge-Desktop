---
name: kwp-finance-journal-entry
...
> Connect ~~erp or Data analysis via `exec` with Python/R, `create_xlsx` for spreadsheets, or `web_search` for benchmarks to pull GL data automatically. You can also paste trial balance data or upload a spreadsheet.
