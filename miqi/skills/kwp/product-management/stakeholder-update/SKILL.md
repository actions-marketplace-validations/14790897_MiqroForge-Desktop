---
name: kwp-product-management-stakeholder-update
...
- If **No chat platform connected — use the current conversation or the `message` tool if configured** is connected, offer to draft the message for sending
