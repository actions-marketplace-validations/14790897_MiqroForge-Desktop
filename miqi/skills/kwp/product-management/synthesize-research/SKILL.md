---
name: kwp-product-management-synthesize-research
...
- **No knowledge base connected — use `web_search` and `read_file` to find documentation** (if connected): Search for research documents, interview notes, survey results
