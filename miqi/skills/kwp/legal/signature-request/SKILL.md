---
name: kwp-legal-signature-request
...
- **URL**: Link to a document in ~~cloud storage or No CLM connected — paste contract text directly or use `read_file` to load from local files
...
3. **Keep a copy** — Executed copies should be filed in ~~cloud storage or No CLM connected — paste contract text directly or use `read_file` to load from local files immediately after execution.
