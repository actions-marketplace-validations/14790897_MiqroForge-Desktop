...
metadata: {"miqi": {"requires": {}, "emoji": "✅", "category": "personal", "source": "knowledge-work-plugins"}}
---
...
2. If not, copy it from `the current workspace skills directory/skills/dashboard.html` to the current working directory
